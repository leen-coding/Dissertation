...
if __name__ == "__main__":
    ...
    Test_loader = torch.utils.data.DataLoader(
        TestDataset(dir=lfw_dir_path, pairs_path=lfw_pairs_path, image_size=input_shape), batch_size=32,
    ...
    if True:
        ...
        gen_val_loss = DataLoader(val_dataset_loss, shuffle=shuffle, batch_size=batch_size, num_workers=num_workers,
                                  pin_memory=True,
        ...
        for epoch in range(Init_Epoch, Epoch):
            ...
            fit_one_epoch(model_train, model, loss_history, optimizer, epoch, epoch_step, epoch_step_val, gen,
                          gen_val_loss, Epoch, Cuda, Test_loader, lfw_eval_flag, fp16, scaler, save_period, save_dir,
                          local_rank)
